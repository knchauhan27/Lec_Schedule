...
async function loadData() {
  try {
    ...
    todayLectures.sort((a, b) => timeToMinutes(a.start) - timeToMinutes(b.start));
    ...
    lectureBlocksEl.innerHTML =
      `<div class="no-lectures">⚠ Failed to load lec.json — ${err.message}</div>`;
  }
}
...
(function enableDragScroll() {
  ...
  containerEl.addEventListener('mouseleave', () => { isDown = false; });
